define('app',['exports', 'aurelia-router'], function (exports, _aureliaRouter) {
  ...
  var App = exports.App = function () {
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.map([{ route: ['', 'spirithighlands'], name: 'spirithighlands', moduleId: 'spirithighlands/spirithighlands' }, { route: 'newplayers', name: 'newplayers', moduleId: 'newplayers/newplayers', nav: true }, { route: 'units', name: 'units', moduleId: 'units/units', nav: true }, { route: 'transcend', name: 'transcend', moduleId: 'transcend/transcend', nav: true }, { route: 'dungeons', name: 'dungeons', moduleId: 'dungeons/dungeons', nav: true }, { route: 'tot', name: 'tot', moduleId: 'tot/tot', nav: true }, { route: 'guildbosses', name: 'guildbosses', moduleId: 'guildbosses/guildbosses', nav: true }]);
    };
...
define('main',['exports', './environment', 'node_modules/babel-polyfill/dist/polyfill.js'], function (exports, _environment) {
  'use strict';
  ...
  function configure(aurelia) {
    aurelia.use.standardConfiguration().globalResources('bootstrap/css/bootstrap.css').feature('resources');
...
define('dungeons/dungeons',['exports', 'aurelia-framework', '../services/dataService'], function (exports, _aureliaFramework, _dataService) {
    'use strict';

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.Dungeons = undefined;
    ...
    var Dungeons = exports.Dungeons = (_dec = (0, _aureliaFramework.inject)(_dataService.DataService), _dec(_class = function Dungeons(DataService) {
        _classCallCheck(this, Dungeons);

        this.DataService = DataService;
    }) || _class);
});
define('guildbosses/guildbosses',['exports', 'aurelia-framework', '../services/dataService'], function (exports, _aureliaFramework, _dataService) {
    'use strict';

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.GuildBosses = undefined;
    ...
    var GuildBosses = exports.GuildBosses = (_dec = (0, _aureliaFramework.inject)(_dataService.DataService), _dec(_class = function GuildBosses(DataService) {
        _classCallCheck(this, GuildBosses);

        this.DataService = DataService;
    }) || _class);
});
define('newplayers/newplayers',['exports', 'aurelia-framework', '../services/dataService'], function (exports, _aureliaFramework, _dataService) {
    'use strict';

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.NewPlayers = undefined;
    ...
    var NewPlayers = exports.NewPlayers = (_dec = (0, _aureliaFramework.inject)(_dataService.DataService), _dec(_class = function NewPlayers(DataService) {
        _classCallCheck(this, NewPlayers);
...
define('resources/index',['exports'], function (exports) {
  ...
  function configure(config) {
    config.globalResources(['./attributes/bootstrap-tooltip']);
  }
});
define('services/dataService',['exports', 'aurelia-fetch-client'], function (exports, _aureliaFetchClient) {
	'use strict';
	...
	var DataService = exports.DataService = function () {
		...
		DataService.prototype.getSpiritData = function getSpiritData() {
			return new Promise(function (resolve, reject) {
				httpClient.fetch('/spiritHighlandsData/', {
					method: 'GET'
...
define('spirithighlands/spirithighlands',['exports', 'aurelia-framework', '../services/dataService'], function (exports, _aureliaFramework, _dataService) {
    'use strict';

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.SpiritHighlands = undefined;
    ...
    var SpiritHighlands = exports.SpiritHighlands = (_dec = (0, _aureliaFramework.inject)(_dataService.DataService), _dec(_class = function () {
        function SpiritHighlands(DataService) {
            _classCallCheck(this, SpiritHighlands);
        ...
        SpiritHighlands.prototype.activate = function activate() {
            var _this = this;

            this.DataService.getSpiritData().then(function (result) {
                _this.data = result;
            });
        };

        SpiritHighlands.prototype.attached = function attached() {
            $('[data-toggle="tooltip"]').tooltip();
        };

        return SpiritHighlands;
    }()) || _class);
});
define('tot/tot',['exports', 'aurelia-framework', '../services/dataService'], function (exports, _aureliaFramework, _dataService) {
    'use strict';

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.ToT = undefined;
    ...
    var ToT = exports.ToT = (_dec = (0, _aureliaFramework.inject)(_dataService.DataService), _dec(_class = function ToT(DataService) {
        _classCallCheck(this, ToT);

        this.DataService = DataService;
    }) || _class);
});
define('transcend/transcend',['exports', 'aurelia-framework', '../services/dataService'], function (exports, _aureliaFramework, _dataService) {
    'use strict';

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.Transcend = undefined;
    ...
    var Transcend = exports.Transcend = (_dec = (0, _aureliaFramework.inject)(_dataService.DataService), _dec(_class = function Transcend(DataService) {
        _classCallCheck(this, Transcend);

        this.DataService = DataService;
    }) || _class);
});
define('units/units',['exports', 'aurelia-framework', '../services/dataService'], function (exports, _aureliaFramework, _dataService) {
    'use strict';
    ...
    var Units = exports.Units = (_dec = (0, _aureliaFramework.inject)(_dataService.DataService), _dec(_class = function Units(DataService) {
        _classCallCheck(this, Units);

        this.DataService = DataService;
    }) || _class);
});
define('resources/attributes/bootstrap-tooltip',['exports', 'aurelia-framework', 'jquery', 'bootstrap'], function (exports, _aureliaFramework, _jquery) {
  'use strict';
  ...
  var BootstrapTooltip = exports.BootstrapTooltip = (_dec = (0, _aureliaFramework.customAttribute)('bootstrap-tooltip'), _dec2 = (0, _aureliaFramework.inject)(Element), _dec(_class = _dec2(_class = function () {
    ...
    BootstrapTooltip.prototype.bind = function bind() {
      (0, _jquery2.default)(this.element).tooltip();
    };

    BootstrapTooltip.prototype.unbind = function unbind() {
      (0, _jquery2.default)(this.element).tooltip('destroy');
    };
...
define('text!app.css', ['module'], function(module) { module.exports = "body {\n  padding-top: 50px;\n  background-color: #101010;\n}\n\nimg:hover{\n    transform: scale(1.5);\n}\n\n.col-xs-5ths,\n.col-sm-5ths,\n.col-md-5ths,\n.col-lg-5ths {\n    position: relative;\n    min-height: 1px;\n    padding-right: 15px;\n    padding-left: 15px;\n}\n\n.col-xs-5ths {\n    width: 20%;\n    float: left;\n}\n@media (min-width: 768px) {\n.col-sm-5ths {\n        width: 20%;\n        float: left;\n    }\n}\n@media (min-width: 992px) {\n    .col-md-5ths {\n        width: 20%;\n        float: left;\n    }\n    .panel-body {\nbackground:rgb(139,139,139);\nmin-height:220px;\n}\n\n.panel-footer{\n    min-height: 70px;\n}\n\n}\n@media (min-width: 1200px) {\n    .col-lg-5ths {\n        width: 20%;\n        float: left;\n    }\n}\n\n.panel-body {\nbackground:rgb(139,139,139);\n}\n\n.row {\n  display: -webkit-box;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display:         flex;\n  flex-wrap: wrap;\n}\n.row > [class*='col-'] {\n  display: flex;\n  flex-direction: column;\n}\n\n.badge-warning {\nbackground-color: #d58512;\n}\n\nimg + span.badge {\n    position: relative;\n    top: -64px;\n    left: 8px;\n}\n\n.trans-image {\n    border: 2px solid #F4CC2B;\n    border-radius: 15px;\n    box-shadow: 0 0 0 2px #F4AA2B;\n}\n.trans-image span {\n    position:absolute;\n    top:0;\n    right:0;\n}\n\n"; });
define('text!app.html', ['module'], function(module) { module.exports = "<template>\n  <require from=\"app.css\"> </require>\n  <nav class=\"navbar navbar-inverse navbar-fixed-top\">\n    <div class=\"container\">\n      <div class=\"navbar-header\">\n        <button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#navbar\" aria-expanded=\"false\"\n          aria-controls=\"navbar\">\n            <span class=\"sr-only\">Toggle navigation</span>\n            <span class=\"icon-bar\"></span>\n            <span class=\"icon-bar\"></span>\n            <span class=\"icon-bar\"></span>\n          </button>\n        <a class=\"navbar-brand\" href=\"#\">Endless Frontier Helper</a>\n      </div>\n      <div id=\"navbar\" class=\"collapse navbar-collapse\">\n        <ul class=\"nav navbar-nav\">\n          <li class=\"active\"><a href=\"#\">Spirit Highlands</a></li>\n          <li><a href=\"#units\">Unit Details</a></li>\n          <li><a href=\"#newplayers\">New Players</a></li>\n          <li><a href=\"#transcend\">Transcending Units</a></li>\n          <li><a href=\"#dungeons\">Dungeons</a></li>\n          <li><a href=\"#tot\">Tower of Trial</a></li>\n          <li><a href=\"#guildbosses\">Guild Bosses</a></li>\n        </ul>\n      </div>\n      <!--/.nav-collapse -->\n    </div>\n  </nav>\n  <div class=\"container-fluid\">\n    <!-- This will be the sectional UI area -->\n    <router-view></router-view>\n  </div>\n</template>"; });
define('text!guildbosses/guildbosses.html', ['module'], function(module) { module.exports = "<template>\n<h1>Guild Bosses Details</h1>\n</template>"; });
define('text!tot/tot.html', ['module'], function(module) { module.exports = "<template>\n    <h1>Tower of Trial Details</h1>\n</template>"; });
define('text!dungeons/dungeons.html', ['module'], function(module) { module.exports = "<template>\n<h1>Dungeon Details</h1>\n</template>"; });
define('text!newplayers/newplayers.html', ['module'], function(module) { module.exports = "<template>\n    <h1>New Player Details</h1>\n</template>"; });
define('text!units/units.html', ['module'], function(module) { module.exports = "<template>\n    <h1>Units Details</h1>\n</template>"; });
define('text!transcend/transcend.html', ['module'], function(module) { module.exports = "<template>\n    <h1>Transcend Details</h1>\n</template>"; });
define('text!spirithighlands/spirithighlands.html', ['module'], function(module) { module.exports = "<template>\n  <require from=\"app.css\"> </require>\n  <div class=\"container-fluid\">\n    <div class=\"row\">\n      <div class=\"col-md-5ths col-xs-12\" repeat.for=\"level of data\">\n        <div class=\"panel panel-default\">\n          <div class=\"panel-heading\">\n            <h3 class=\"panel-title\">Level ${level.Level} ${level.rewardtype}</h3>\n          </div>\n          <div class=\"panel-body\">\n            <h3 if.bind=\"level.rewardtype === 'Diamond' || level.rewardtype === 'Honor' \">${level.reward} x <img src.bind=\"level.rewardIcon\" width=\"32px\" height=\"32px\"></h3>\n            <h3 if.bind=\"level.rewardtype === 'Fragment' \">${level.reward} x <img src.bind=\"level.rewardIcon\" width=\"64px\" height=\"64px\" bootstrap-tooltip data-toggle=\"tooltip\"\n                title=\"${level.fragmentName}\">\n              <img if.bind=\"level.luck\" src=\"images/Dice.png\" width=\"32px\" height=\"32px\" bootstrap-tooltip data-toggle=\"tooltip\" title=\"Luck is required to win with this combination!\">\n            </h3>\n            <img repeat.for=\"u of level.Units\" src.bind=\"u.icon\" alt.bind=\"u.abbr\" width=\"48px\" height=\"48px\" bootstrap-tooltip data-toggle=\"tooltip\"\n              title=\"${u.name}\" class=\"${u.trans ? 'trans-image':''}\" />\n          </div>\n          <div class=\"panel-footer\">\n            <h5>${level.summary}</h5>\n          </div>\n        </div>\n      </div>\n    </div>\n    <!-- ROW END -->\n    <!-- /.container -->\n</template>"; });
